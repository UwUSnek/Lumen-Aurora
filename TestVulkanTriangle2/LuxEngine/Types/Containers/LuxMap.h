...
namespace lux {
	...
	public:
		...
		Map(const ContainerBase<elmType, alloc>* in) {
		...
		Array<alloc> __vectorcall add(const std::vector<type>* pVector) {
			Array<alloc> IDs;
		...
		Array<alloc> __vectorcall add(const Map<type, alloc>* vContainer) {
			Array<alloc> IDs;
