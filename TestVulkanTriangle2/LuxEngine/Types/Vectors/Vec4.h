...
struct name {																														\
	...
	inline __vectorcall name(const t##ref _x, const t##ref _y, const t##ref _z, const t##ref _w) { x = _x; y = _y; z = _z; w = _w; }\
	inline __vectorcall name(const _vec2<t>##ref xy, const _vec2<t>##ref zw) { x = xy.x; y = xy.y; z = zw.z; w = zw.w; }			\
	inline __vectorcall name(const _vec3<t>##ref v, const t##ref _w) { x = v.x; y = v.y; z = v.z; w = _w; }							\
	inline __vectorcall name(const t##ref _x, const _vec3<t>##ref v) { x = _x; y = v.y; z = v.z; w = v.w; }							\
	inline __vectorcall name(const _vec2<t>##ref v, const t##ref _z, const t##ref _w) { x = v.x; y = v.y; z = _z; w = _w; }			\
	inline __vectorcall name(const t##ref _x, const t##ref _y, const _vec2<t>##ref v) { x = _x; y = _y; z = v.z; w = v.w; }			\
																																	\
