...
typedef _vec2<type> vec2##type, v2##type;																																					\
typedef _vec3<type> vec3##type, v3##type;																																					\
typedef _vec4<type> vec4##type, v4##type;																																					\
...
__lp_vec_def(int32, Int32, &)		__lp_vec_def(uint32, Uint32, &)		__lp_vec_def(float32, Float, &)
__lp_vec_def(int64, Int64, &)		__lp_vec_def(uint64, Uint64, &)		__lp_vec_def(float64, Double, &)
#undef __lp_vec_def
