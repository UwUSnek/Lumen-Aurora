...
static inline type __vectorcall dist##typen(const _vec2<type>##pass a, const _vec2<type>##pass b) { return (sqrt(pow(b.x - a.x, 2) + pow(b.y - a.y, 2))); }						\
static inline type __vectorcall dist##typen(const _vec3<type>##pass a, const _vec3<type>##pass b) { return (sqrt(pow(b.x - a.x, 2) + pow(b.y - a.y, 2) + pow(b.z - a.z, 2))); }	\
