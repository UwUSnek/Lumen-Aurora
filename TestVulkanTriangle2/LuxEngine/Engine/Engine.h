...
//         |  struct  | physics mapped ptr <---,   OBJECT         |   |  Object 0| physics data | Object 1| physics data | Object 2| physics data | |                                                                                                                                 
...
//  | | |  |          '--------------------'                      |   |             '---↑------------------------↑-----------------------↑-----'    |                                                                                                                                
//  | | |  ',____________________________________________________,'   ',________________|________________________|_______________________|_________,'                                                                                                      
//  | | |                                                                               |                        |                       |                                                        
//  | | |                                            updateFromCpu/Gpu()                |                        |                       |                                                        
//  | | '----------------------------------------------------,--------------------------'   updateFromCpu/Gpu()  |                       |                
//  | '------------------------------------------------------|--------------------------------------,------------' updateFromCpu/Gpu()   |                
