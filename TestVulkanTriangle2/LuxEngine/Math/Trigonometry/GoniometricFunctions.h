...
//TODO add
#if FUNC_PRECISION != 0
template<class T> constexpr auto __vectorcall fsin(T n) { return sign(n) * __lp_sin[scast<uint32>(abs(n) * FUNC_PRECISION) % FUNC_PRECISION]; }	//Fast sine function that uses a precomputed values to improve performance. Precision: 1/FUNC_PRECISION
...
template<class T> constexpr auto __vectorcall ftan(T n) { return sign(n) * __lp_tan[scast<uint32>(abs(n) * FUNC_PRECISION) % FUNC_PRECISION]; }	//Fast tangent function that uses a precomputed values to improve performance. Precision: 1/FUNC_PRECISION
template<class T> constexpr auto __vectorcall fcot(T n) { return sign(n) * __lp_cot[scast<uint32>(abs(n) * FUNC_PRECISION) % FUNC_PRECISION]; }	//Fast cotangent function that uses a precomputed values to improve performance. Precision: 1/FUNC_PRECISION
...
template<class T> constexpr auto __vectorcall fcsc(T n) { return sign(n) * __lp_csc[scast<uint32>(abs(n) * FUNC_PRECISION) % FUNC_PRECISION]; }	//Fast cosecant function that uses a precomputed values to improve performance. Precision: 1/FUNC_PRECISION
...
template<class T> constexpr auto __vectorcall fsin2(T n) { return sign(n) * __lp_sin[scast<uint32>(abs(n) * FUNC_PRECISION)]; }					//Faster version of fsin. This works only with integral values
...
template<class T> constexpr auto __vectorcall ftan2(T n) { return sign(n) * __lp_tan[scast<uint32>(abs(n) * FUNC_PRECISION)]; }					//Faster version of ftan. This works only with integral values
template<class T> constexpr auto __vectorcall fcot2(T n) { return sign(n) * __lp_cot[scast<uint32>(abs(n) * FUNC_PRECISION)]; }					//Faster version of fcot. This works only with integral values
...
template<class T> constexpr auto __vectorcall fcsc2(T n) { return sign(n) * __lp_csc[scast<uint32>(abs(n) * FUNC_PRECISION)]; }					//Faster version of fcsc. This works only with integral values
