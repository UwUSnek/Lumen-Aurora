#pragma once
#define LUX_H_GONIOMETRIC_FUNCTIONS
...
//TODO add
#ifdef LUX_CNF_USE_FFUNCTIONS
template<class T> constexpr auto fsin(T n) { return signNz(n) * __lp_sin[scast<uint32>(abs(n) * LUX_CNF_FFUNCTIONS_PRECISION) % LUX_CNF_FFUNCTIONS_PRECISION]; }	//Fast sine      function that uses precomputed values to improve performance. Precision: 1/LUX_CNF_FFUNCTIONS_PRECISION
template<class T> constexpr auto fcos(T n) { return             __lp_cos[scast<uint32>(abs(n) * LUX_CNF_FFUNCTIONS_PRECISION) % LUX_CNF_FFUNCTIONS_PRECISION]; }	//Fast cosine    function that uses precomputed values to improve performance. Precision: 1/LUX_CNF_FFUNCTIONS_PRECISION
template<class T> constexpr auto ftan(T n) { return signNz(n) * __lp_tan[scast<uint32>(abs(n) * LUX_CNF_FFUNCTIONS_PRECISION) % LUX_CNF_FFUNCTIONS_PRECISION]; }	//Fast tangent   function that uses precomputed values to improve performance. Precision: 1/LUX_CNF_FFUNCTIONS_PRECISION
template<class T> constexpr auto fcot(T n) { return signNz(n) * __lp_cot[scast<uint32>(abs(n) * LUX_CNF_FFUNCTIONS_PRECISION) % LUX_CNF_FFUNCTIONS_PRECISION]; }	//Fast cotangent function that uses precomputed values to improve performance. Precision: 1/LUX_CNF_FFUNCTIONS_PRECISION
template<class T> constexpr auto fsec(T n) { return             __lp_sec[scast<uint32>(abs(n) * LUX_CNF_FFUNCTIONS_PRECISION) % LUX_CNF_FFUNCTIONS_PRECISION]; }	//Fast secant    function that uses precomputed values to improve performance. Precision: 1/LUX_CNF_FFUNCTIONS_PRECISION
template<class T> constexpr auto fcsc(T n) { return signNz(n) * __lp_csc[scast<uint32>(abs(n) * LUX_CNF_FFUNCTIONS_PRECISION) % LUX_CNF_FFUNCTIONS_PRECISION]; }	//Fast cosecant  function that uses precomputed values to improve performance. Precision: 1/LUX_CNF_FFUNCTIONS_PRECISION
