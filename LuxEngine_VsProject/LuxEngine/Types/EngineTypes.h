...
typedef uint32 LuxBuffer, LuxShader;
...
////#LLID ECF0000
////Returns a LuxCell created from is buffer index, cell count, cell index and shared properties
...
//
//
//static constexpr bool   getCellType(LuxCell vCell) { return vCell >> 63; }													//Returns true if the cell is in a fixed count buffer, false if it's a custom count one
...
//static constexpr uint32 getCellSize(LuxCell vCell) { return (vCell) & 0x3FFffff; }											//Returns the count of a LuxShader in bytes
