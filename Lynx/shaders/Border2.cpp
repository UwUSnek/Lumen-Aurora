...
namespace lnx::shd{
	...
	LnxAutoInit(LNX_H_BORDER2){
		...
		{ //Create descriptor set layout
			...
			switch(core::dvc::graphics.LD.createDescriptorSetLayout(&layoutCreateInfo, nullptr, &Border2::layout.descriptorSetLayout)){ vkDefaultCases2; }
		}
		...
		{ //Create pipeline layout
			...
			auto pipelineLayoutCreateInfo = vk::PipelineLayoutCreateInfo()
				...
				.setPSetLayouts    (&Border2::layout.descriptorSetLayout)
			;
			switch(core::dvc::graphics.LD.createPipelineLayout(&pipelineLayoutCreateInfo, nullptr, &Border2::layout.pipelineLayout)){ vkDefaultCases2; }
		}
	}
}