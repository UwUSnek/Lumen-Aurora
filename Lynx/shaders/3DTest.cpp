...
namespace lnx::shd{
	...
	void _3DTest::create(vram::ptr<f32v4, VRam, Storage> pOutcol, vram::ptr<u32v2, VRam, Storage> pWsize, vram::ptr<f32v4, VRam, Storage> pData, const u32v3 vGroupCount, Window& pWindow){
		pWindow.addObject_m.lock();
			_outcol.vdata = (vram::ptr<char, VRam, Storage>)pOutcol;
			_wsize.vdata = (vram::ptr<char, VRam, Storage>)pWsize;
			_data.vdata = (vram::ptr<char, VRam, Storage>)pData;
