...
namespace lux::core::c{
	...
	void init(){
		{ //Initialize window buffers and count
			render::wnd::gpuCellWindowOutput_i	= rem::allocBck(render::wnd::width * render::wnd::height * 4, 	CellClass::AUTO, lux::__pvt::AllocType::DEDICATED_STORAGE); //A8-R8-G8-B8 UI
			render::wnd::gpuCellWindowOutput	= rem::allocBck(render::wnd::width * render::wnd::height * 4 * 4,	CellClass::AUTO, lux::__pvt::AllocType::DEDICATED_STORAGE); //A32-R32-G32-B32 UF
			render::wnd::gpuCellWindowZBuffer 	= rem::allocBck(render::wnd::width * render::wnd::height * 4, 	CellClass::AUTO, lux::__pvt::AllocType::DEDICATED_STORAGE);

			render::wnd::gpuCellWindowSize = rem::allocBck(4 * 2,  CellClass::AUTO, lux::__pvt::AllocType::SHARED_STORAGE);	//Create cell for window size //TODO use dedicated storage and update every time
	...
	//> Engine internal use
	void computeCleanup( ) {
		for(uint32 i = 0; i < /*rem::buffers.count( )*/(uint32)lux::__pvt::CellClassIndex::NUM * (uint32)lux::__pvt::AllocType::NUM; ++i) {
