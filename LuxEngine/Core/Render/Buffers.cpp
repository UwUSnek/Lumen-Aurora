...
namespace lux::core::buffers{
	...
	void init() {
		{ //Initialize window buffers and count
			...
			render::wnd::gpuCellWindowOutput_i.alloc_(render::wnd::width * render::wnd::height * 4,     VCellClass::CLASS_A); //A8-R8-G8-B8 UI
			render::wnd::gpuCellWindowOutput.  alloc_(render::wnd::width * render::wnd::height * 4 * 4, VCellClass::CLASS_A); //A32-R32-G32-B32 UF
			render::wnd::gpuCellWindowZBuffer. alloc_(render::wnd::width * render::wnd::height * 4,     VCellClass::CLASS_A);
			render::wnd::gpuCellWindowSize.alloc_(4 * 2, VCellClass::CLASS_A);	//Create cell for window size //TODO use dedicated storage and update every time
