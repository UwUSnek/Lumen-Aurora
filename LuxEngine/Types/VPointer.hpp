...
#include "LuxEngine/Core/Memory/Ram/VCell_t.hpp"
...
namespace lux::rem{
	...
	public:
		Cell_t* cell; //A pointer to a lux::rem::Cell_t object that contains the cell informations
	...
	template<class type> void lux::ram::Alloc<type>::alloc_(const uint64 vSize, const VCellClass vClass) {
		using namespace lux::__pvt;
		cells_m.lock();
