...
namespace lux::rem{
	...
	Cell allocBck(const uint64 vSize, CellClass vCellClass, const AllocType vAllocType){
		...
		luxCheckParam(vAllocType >= AllocType::NUM || (int32)vAllocType < 0,		vAllocType, "The allocation type can only be 'DEDICATED_STORAGE', 'DEDICATED_UNIFORM', 'SHARED_STORAGE' or 'SHARED_UNIFORM'");
