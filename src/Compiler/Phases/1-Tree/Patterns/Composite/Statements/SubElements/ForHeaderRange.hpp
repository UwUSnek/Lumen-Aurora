...
namespace cmp {
    struct ST_Sttm_ForHeaderRange : public virtual __base_ST, public virtual __base_ST_Referable {
        ptr<__base_ST> from;
        ptr<__base_ST> to;
    ...
    struct Pattern_Sttm_ForHeaderRange : public virtual __base_Pattern_Composite {
        void init();
