...
namespace cmp {
    struct ST_Sttm_ForHeaderStandard : public virtual __base_ST {
        ptr<__base_ST> initializer; //! Either an expression or a variable declaration
        ptr<__base_ST> condition;
        ptr<__base_ST> iteration;
    ...
    struct Pattern_Sttm_ForHeaderStandard : public virtual __base_Pattern_Composite {
        void init();
