...
namespace cmp {
    struct ST_BasicParameter : public virtual __base_ST_Referable, public virtual __base_ST_Typed {
    ...
    struct Pattern_Elm_BasicParameter : public virtual __base_Pattern_Composite {
        void init();
