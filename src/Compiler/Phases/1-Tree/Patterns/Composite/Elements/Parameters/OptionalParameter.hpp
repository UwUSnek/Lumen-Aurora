...
namespace cmp {
    struct ST_OptionalParameter : public virtual __base_ST_Referable, public virtual __base_ST_Typed {
        ptr<__base_ST> defaultValue;
    ...
    struct Pattern_Elm_OptionalParameter : public virtual __base_Pattern_Composite {
        void init();
