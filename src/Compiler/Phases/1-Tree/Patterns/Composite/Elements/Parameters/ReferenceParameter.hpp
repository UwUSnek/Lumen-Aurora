...
namespace cmp {
    struct ST_ReferenceParameter : public virtual __base_ST_Referable, public virtual __base_ST_Typed {
    ...
    struct Pattern_Elm_ReferenceParameter : public virtual __base_Pattern_Composite {
        void init();
