...
namespace cmp {
    struct ST_Type_Function : public virtual __base_ST {
        ptr<__base_ST> returnType;
        std::vector<ptr<__base_ST>> paramTypes;
    ...
    struct Pattern_Type_Function : public virtual __base_Pattern_Composite {
        void init();
