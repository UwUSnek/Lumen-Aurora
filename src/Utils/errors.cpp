...
void utils::printErrorGeneric(ErrorCode errorCode, const std::string &message) {
    cerr++;
...
void utils::printErrorCL(ErrorCode errorCode, cmd::ElmCoordsCL const &_relPos, cmd::ElmCoordsCL const &_errPos, const std::string &message, const std::string &fullCommand) {
 ...
 */
  void utils::printError(ErrorCode errorCode, ErrType errType, ElmCoords const &_errPos, const std::string &message) {
 ...
 *      The error message will be colored red and displayed as bold. ansi::reset will reset to bold red.
 */
void utils::printError(ErrorCode errorCode, ErrType errType, ElmCoords const &_relPos, ElmCoords const &_errPos, const std::string &message) {
