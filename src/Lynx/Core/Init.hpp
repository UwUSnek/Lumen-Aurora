...
#define _lnx_init_var_def2(vType, vName, vCount, vId, vEndType, vDeref)    \
	...
	_dbg(used inline DEL_P(vEndType) g_##vName(){)                         \
	_	lnx::dbg::assertCond(                                              \
	_		_pvt::vId##_is_init,)                                          \
	_		"Global variable \"g_" #vName "\" used before initialization") \
	_	);)                                                                \
	_	return vDeref _pvt::vId##_v;)                                      \
	_};)                                                                   \
...
// #define _lnx_init_var_dec2(vName, vId, vEndType, vDeref)\
// 	used _dbg(inline) _rls(alwaysInline) DEL_P(vEndType) g_##vName()z
...
// 	}                                                                      \
// 	/*Debug get function definition*/                                      \
// 	used _dbg(inline) _rls(alwaysInline) DEL_P(vEndType) g_##vName(){      \
// 	lnx::dbg::assertCond(                                                  \
// 			_pvt::vId##_is_init,                                           \
