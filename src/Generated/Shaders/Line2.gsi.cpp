...
namespace lnx::shd::gsi{
	...
	_lnx_init_var_redirect_value_def((InterfaceLayout), Line2_layout,        lnx::shd::gsi){}
	_lnx_init_var_redirect_value_def((uint32),          Line2_pipelineIndex, lnx::shd::gsi){ *pVar = core::shaders::g_pipelineNum()++; }
