...
namespace lnx::shd::gsi::_pvt {
    ...
    used static _pvt::_lnx_init_fun_LNX_H_BORDER2_FUN_t& _lnx_init_var_LNX_H_BORDER2_FUN_v = _lnx_init_var_LNX_H_BORDER2_FUN_get();
    extern bool _lnx_init_var_LNX_H_BORDER2_FUN_is_init;/*Zero initialized before global constructors*/
}