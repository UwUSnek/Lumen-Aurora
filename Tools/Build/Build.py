...
if args.h:
    print(
        ...
        '\n        --verbosity    Choose output verbosity. Default: 1. Possible values: 0, 1, 2, 3. Ignored when none of -c, -C, -b or -B is used'
        '\n'
        '\nBuild options:'
        ...
        '\n    -m  --mode         Specify target platform and build configuration      Ignored when both -b and -B are not used'
        '\n    -p  --pack         Pack all files in a single executable file.          Ignored when both -b and -B are not used'
        '\n'
        '\nVerbosity levels:'
        '\n    #''TODO'
        '\n'
