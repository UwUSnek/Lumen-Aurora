...
static struct TypeData_t* type_get_data(const enum TokenID id){
	static struct TypeData_t data[] = {
	...
	return data + id - t_start;
}

static const char* type_to_str(const enum TokenID id) {
