...
def parseShader(pathr:str, ptoe:str, isEngine:bool):
    #Check files
    ...
    incShPath : str = os.path.dirname(os.path.relpath(pathr, ptoe if isEngine else '.')) #FIXME
    ...
    with open(shPath + '/' + shName + '.gsi.hpp', 'w') as fh, open(shPath + '/' + shName + '.gsi.cpp', 'w') as fc:
        ...
        fh.write(fixTabs(
            f"\n//####################################################################################"
            f"\n// This file was generated by { ptoe }/Tools/Build/GlslToCpp"
